...
public class Window {
    ...
    public void init() {
        ...
        setWindowConfig(maximized);
        // Create window
        createWindow();
        setFrameBufferSizeCallback();
        // Setup a key callback. It will be called every time a key is pressed, repeated or released.
        setKeyCallback();
        centerOrMaximizeWindow(maximized);
	 ...
	 * @param maximized
	 */
	private void centerOrMaximizeWindow(boolean maximized) {
		if(maximized) {
	 ...
	 * @return
	 */
	private void setWindowConfig(boolean maximized) {
		if (width == 0 || height == 0) {
